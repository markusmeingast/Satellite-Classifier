...
X_train = np.load('../00-raw-data/roof-dataset/pre/image-train-0.npy')[0:100]
...
converter = tf.compat.v1.lite.TFLiteConverter.from_keras_model_file('../03-Models/keras_model_roof.h5')
